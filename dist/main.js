...
/***/ "./src/configurations/constVariables.js":
/*!**********************************************!*\
  !*** ./src/configurations/constVariables.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"HARRYPORTERMOVIESURL\": () => (/* binding */ HARRYPORTERMOVIESURL),\n/* harmony export */   \"LIKESURL\": () => (/* binding */ LIKESURL),\n/* harmony export */   \"MOVIEDETAILSURL\": () => (/* binding */ MOVIEDETAILSURL)\n/* harmony export */ });\nconst HARRYPORTERMOVIESURL = 'https://search.imdbot.workers.dev/?q=Harry%20Potter';\n\nconst MOVIEDETAILSURL = 'https://search.imdbot.workers.dev/'\n\nconst LIKESURL = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/JIjFwoEkLZESIoGzrK2r/likes';\n\n\n\n//# sourceURL=webpack://javascript-capstone/./src/configurations/constVariables.js?");

/***/ }),

/***/ "./src/configurations/utilities.js":
/*!*****************************************!*\
  !*** ./src/configurations/utilities.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"fetchLikes\": () => (/* binding */ fetchLikes),\n/* harmony export */   \"fetchMovieData\": () => (/* binding */ fetchMovieData),\n/* harmony export */   \"fetchMovieDetails\": () => (/* binding */ fetchMovieDetails),\n/* harmony export */   \"postLikes\": () => (/* binding */ postLikes)\n/* harmony export */ });\n/* harmony import */ var _constVariables_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constVariables.js */ \"./src/configurations/constVariables.js\");\n\n\nconst fetchMovieData = async () => {\n  const response = await fetch(_constVariables_js__WEBPACK_IMPORTED_MODULE_0__.HARRYPORTERMOVIESURL);\n  const data = await response.json();\n  const info = data.description;\n  return info;\n};\n\nconst fetchMovieDetails = async (id) => {\n    const response = await fetch(`${_constVariables_js__WEBPACK_IMPORTED_MODULE_0__.MOVIEDETAILSURL}?tt=${id}`);\n    const data = await response.json();\n    return data;\n};\n\nconst fetchLikes = async () => {\n  const response = await fetch(_constVariables_js__WEBPACK_IMPORTED_MODULE_0__.LIKESURL);\n  const data = await response.json();\n  return data;\n};\n\nconst postLikes = async (id) => {\n    const response = await fetch(_constVariables_js__WEBPACK_IMPORTED_MODULE_0__.LIKESURL, {\n        method: 'POST',\n        headers: {\n            'Content-type': 'application/json',\n        },\n        body: JSON.stringify({ item_id: id }),\n    });\n    const data = response.text();\n    const { result } = data;\n    return result;\n};\n\n\n//# sourceURL=webpack://javascript-capstone/./src/configurations/utilities.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_displayMovies_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/displayMovies.js */ \"./src/modules/displayMovies.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\n\r\ndocument.addEventListener('DOMContentLoaded', _modules_displayMovies_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\r\n\n\n//# sourceURL=webpack://javascript-capstone/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst counter = (data) => {\r\n    const movie = document.getElementById('movie');\r\n    movie.innerHTML += `(${data.length})`;\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (counter);\n\n//# sourceURL=webpack://javascript-capstone/./src/modules/itemsCounter.js?");
